...
function randClusterPoint(xI,yI){
    return [100+xI*(W-200*2), 100+yI*(W-200*2)];
}
...
function genData2(N, M) {
    ...
    for (var i = 0; i < MYDATA.length; i++) {
        var cluster = randClusterPoint(MYDATA[i].x, MYDATA[i].y);//R
...
function clear () {
  tree = RTree();
  draw();
    d3.csv("a1.csv", function(dataset){
